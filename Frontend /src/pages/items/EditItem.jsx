  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setFormData({
          tenant: itemRes.data.tenant,
          sku: itemRes.data.sku,
          name: itemRes.data.name,
          type: itemRes.data.type,
          category: itemRes.data.category,
          sell_price: itemRes.data.sell_price,
          cost_price: itemRes.data.cost_price,
          tax_rate_percent: itemRes.data.tax_rate_percent,
        });
      } catch (err) {
