...
const navItems = [
  ...
  { path: "/item-categories", label: "Item Categories", icon: <FaTags /> },
  { path: "/item-prices", label: "Item Prices", icon: <FaDollarSign /> },
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-64 bg-gradient-to-b from-blue-200 via-purple-200 to-pink-200 text-gray-800 border-r border-gray-300 flex-col">
        <nav className="flex-1 mt-4">{renderNavItems()}</nav>
      </aside>
